...
- Get [Support](https://app-generator.dev/ticket/create/?generated_repo=https://github.com/app-generator/django-corporate-1755208753) via `eMail` and `Discord`
- Resources:
...
```bash
$ git clone https://github.com/django-corporate-1755208753.git
$ cd django-corporate-1755208753
```
